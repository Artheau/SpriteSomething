...
class Plugins(PluginsParent):
	...
	def get_spritesomething_sprites(self):
		success = gui_common.get_sprites(
			self,
			"Unofficial SpriteSomething Dragon Warrior/Loto-3",
			"nes/dragonwarrior/loto3/sheets/unofficial",
			"https://miketrethewey.github.io/SpriteSomething-collections/nes/dragonwarrior/loto3/sprites.json"
		)
		return success
