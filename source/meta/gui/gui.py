...
class SpriteSomethingMainFrame(tk.Frame):
    ...
    def create_menu_bar(self):
        ...
        export_menu = self.create_cascade(
            ...
            [
              ...
              (
                  self.fish.translate("meta","menu","export.animation-as-apng"),
                  "animation-as-apng",
                  self.export_animation_as_apng
              ),
              (
    ...
    def export_animation_as_apng(self):
        ...
        filetypes = (
            (
                self.fish.translate("meta","dialogue","file.save.apng"),
                "*.png"
            ),
        )
        ...
        if filename:
            returnvalue = self.animation_engine.export_animation_as_apng(
                filename,
