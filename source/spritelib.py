...
class SpriteParent():
	...
	def __init__(self, filename, manifest_dict, my_subpath):
		...
		self.current_animation = next(iter(self.animations.keys())) #TODO: get this out of here, factor out to some common "state of sprite animation" class
		self.frame_getter = lambda: 0   #TODO: get this out of here, goes to "state of sprite" class
		self.zoom_getter = lambda: 1   #TODO: get this out of here, goes to "state of sprite" class
