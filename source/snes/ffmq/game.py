...
class Game(GameParent):
    def __init__(self, my_subpath=""):
        ...
        self.name = "Final Fantasy Mystic Quest"  #to be replaced by a name like "Super Metroid"
        self.console_name = "snes"			#to be replaced by the console name, e.g. "snes"
        self.internal_name = "ffmq"	#to be replaced by the specific folder name that this app uses, e.g. "metroid3"
