...
class RomHandler(snes.RomHandlerParent):
	...
	def _apply_improvements(self):
		...
		#makes samus be able to breathe after she ran into a wall
		self._apply_single_fix_to_snes_address(0x91B010+0x89*2,0xB2B4,0xB298,2)
		self._apply_single_fix_to_snes_address(0x91B010+0x8A*2,0xB2B4,0xB298,2)
