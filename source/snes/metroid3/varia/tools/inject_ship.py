...
if not args.vanilla:
    print("Provide path to Super Metroid (Japan, USA) at --rom")
    exit(1)

if not args.ship_template:
    print("Provide Ship Template at --png")
    exit(1)
...
if not args.no_ship:
    ...
    if enableShipGlowCustom:
        ...
        # print("final palette, {} colors: {}".format(len(paletteFinal), [hex(c) for c in paletteFinal]))
        print("final palette (custom glow) RGB: {}".format(paletteFinalRGB))
