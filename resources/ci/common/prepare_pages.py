...
spriteTemplateFile = open(os.path.join(".","html","template","sprites.html"))
...
with open(os.path.join("..","pages","resources","app","meta","manifests","consoles.txt"),"w+") as consoleList:
  for console in consoles:
    ...
    with open(os.path.join("..","pages","resources","app",console,"games.txt"),"w+") as gameList:
      for game in consoles[console]:
        gamedir = os.path.join(consoledir,game)
        gameList.write("%s\n" % game)
        sprites = []
        with open(os.path.join(gamedir,"manifests","manifest.json")) as manifestFile:
        ...
        for sprite in sprites:
          ...
          with open(os.path.join(spritedir,"sprites.html"),"w+") as spriteFile:
            thisSpriteTemplate = spriteTemplate.replace("<CONSOLE>",console)
            thisSpriteTemplate = thisSpriteTemplate.replace("<GAME>",game)
            thisSpriteTemplate = thisSpriteTemplate.replace("<SPRITE>",sprite)
